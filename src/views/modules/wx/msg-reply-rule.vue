  ...
  <div class="mod-config">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          v-if="isAuth('wx:msgreplyrule:save')"
          type="primary"
          @click="addOrUpdateHandle()"
          >新增</el-button
        >
        <el-button
          v-if="isAuth('wx:msgreplyrule:delete')"
          type="danger"
          @click="deleteHandle()"
...
<script>
import { getDataList, remove } from "@/api/wx/wxautoreply";
  ...
  methods: {
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        remove(this.$http.adornData(ids, false)).then(({ data }) => {
          if (data && data.code === 200) {
            this.$message({
              message: "操作成功",
              type: "success",
